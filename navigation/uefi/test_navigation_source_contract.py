...
required = (
    ...
    'HII_GRAPH_NAV_REFERENCE_ENTER=PASS',
    'HII_GRAPH_NAV_HISTORY_BACK=PASS',
    'HII_GRAPH_NAV_FORM_ID_TRACKING=PASS',
    'HII_GRAPH_NAV_QUESTION_ID_TRACKING=PASS',
    'HII_GRAPH_NAV_REFERENCE_TARGET_TRACKING=PASS',
