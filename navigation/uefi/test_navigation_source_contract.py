...
required = (
    ...
    'HII_GRAPH_SPEECH_QUEUE=INTERRUPTIBLE_127',
    ...
    'QEV_NAV_TEXT_MAX (QEV_UTTERANCE_CAP - 1u)',
    ...
    'HII_GRAPH_NAV_SEMANTIC_SPEECH=SEMANTIC_CORE_ROLE_STATE_LABEL_VALUE',
    'HII_GRAPH_NAV_SEMANTIC_CORE=PASS',
    'HII_GRAPH_NAV_SEMANTIC_EVENT_POLICY=PASS',
    'HII_GRAPH_NAV_SEMANTIC_PASSWORD_POLICY=PASS',
    'nav_semantic_role_from_ifr',
    'nav_semantic_states',
    'qev_semantic_focus_utterance',
    'qev_semantic_event_priority',
    'qev_semantic_event_interrupt',
