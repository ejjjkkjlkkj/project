...
static int nav_build_focus_speech(void *system_table, u8 prompt_index,
    ...
    /*
     * The speech DMA path accepts at most 32 characters. Preserve the live
     * value at the end; truncate semantic prefix/label first. Password values
     * are never appended because the semantic prefix already says protected.
     */
