...
assert data["active_notebook_root_forms"] == [10006,10007,10008,10009,10010]
...
for prompt in (
    ...
    assert data["required_controls"].get(prompt), prompt
...
print("M1603QA_308_RUNTIME_FORM_BROWSER=PASS")
